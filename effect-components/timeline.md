...
### Display different text between stages
```yaml
text: "WELCOME TO SKYBLOCK"
...
Timeline text overrides can be used when one effect should rotate through different words or messages.
