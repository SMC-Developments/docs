...
<br>Supports the MiniMessage and Minecraft color formats accepted by SMC-Core. When configured, it overrides colors already present in the resolved source text.
