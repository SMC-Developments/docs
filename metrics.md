...
<br>Check the [Calculations](metric-components/calculations.md) section for more information.
...
<br>Check the [Results](metric-components/results.md) section for more information.
